...
nusc_train_pkl = 'nuscenes_infos_train_mono_front_bevdet.pkl'
nusc_val_pkl = 'nuscenes_infos_val_part_mono_front_bevdet.pkl'
nusc_h = 450
nusc_w = 800
nusc_h_crop = 307
nusc_w_crop = 800
...
pad_w = 960
focal_length=1000
work_dir = 'work_dirs_bevdet_goodmono_withaug/1.00N_fx1000_gooddataset'
resume = True
# Model
# lss: h w
# resize: w h
