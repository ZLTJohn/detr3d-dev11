...
pad_w = 960
focal_length=1000
work_dir = 'work_dirs_bevdet_goodmono_withaug/1.00N_fx1000_good_rotate_noaug'
resume = True
# Model
# lss: h w
# resize: w h
...
nusc_input_default = [
    ...
    dict(type='LoadAnnotations3D', with_bbox_3d=True, with_label_3d=True, with_attr_label=False),
    dict(type='ProjectLabelToWaymoClass', class_names = nusc_class_names),
    dict(type='GlobalRotScaleTrans',rot_range=[-1.5708,-1.5708]),
]
nusc_train_pipeline = [
    *nusc_input_default,
    # *bev_aug,
...
lyft_input_default = [
    ...
    dict(type='GlobalRotScaleTrans',rot_range=[-3.1416,-3.1416]),
]
