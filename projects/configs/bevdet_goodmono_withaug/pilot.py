...
from projects.bevdet.debug import K360_class_names, K360_name_map
...
pad_w = 960
focal_length=1000
work_dir = 'work_dirs_bevdet_goodrotate_withaug/debug'
resume = True
# Model
# lss: h w
# resize: w h
...
joint_train = dict(
        ...
        datasets=[waymo_train])
joint_val = dict(
        type='CustomConcatDataset',
        datasets=[
            argo2_val,
                  nusc_test,lyft_big_val, lyft_small_val,
