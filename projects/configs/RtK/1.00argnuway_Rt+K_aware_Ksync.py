...
waymo_train_interval = 3    # 2Hz_part means interval = 5x3
...
base_dist = 51.2
base_fxfy = 2068.5
work_dir = './work_dirs_RtK/1.00argnuway_RtK_aware_Ksync'
