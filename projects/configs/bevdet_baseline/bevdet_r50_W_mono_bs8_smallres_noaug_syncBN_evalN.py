...
nusc_train_pkl = 'nuscenes_infos_train_part_mono_front.pkl'
nusc_val_pkl = 'nuscenes_infos_val_part_mono_front.pkl'
work_dir = 'work_dirs_bevdet/W_r50_mono_bs8_smallres_no_aug_syncBN_evalN'
# Model
grid_config = {
    'x': [-51.2, 51.2, 0.8],
    'y': [-51.2, 51.2, 0.8],
...
model = dict(
    ...
    img_view_transformer=dict(
        ...
        input_size=[waymo_crop_hw,waymo_crop_hw],
        dataset_names = ['waymo','nuscenes'],
        downsample=16,
        in_channels=256,
        out_channels=64,
        accelerate=False),
