...
waymo_img_aug_training = [dict(type='MultiViewWrapper',
    transforms=[
        dict(type='RandomResize', ratio_range=(0.92, 1.08), scale=waymo_scale),
