...
work_dir = 'work_dirs_bevdet/NWLAKK360_r50_mono_bs8_smallres_no_aug_syncBN'
# Model
grid_config = {
    'x': [-51.2, 51.2, 0.8],
    'y': [-51.2, 51.2, 0.8],
...
model = dict(
    ...
    img_view_transformer=dict(
        ...
        input_size=[waymo_crop_hw,waymo_crop_hw,waymo_crop_hw,waymo_crop_hw,waymo_crop_hw,waymo_crop_hw],
        dataset_names = ['waymo','nuscenes','lyft','argoverse2','kitti','kitti-360'],
        downsample=16,
        in_channels=256,
        out_channels=64,
        accelerate=False),
...
joint_train = dict(
        ...
        datasets=[nusc_train, waymo_train, lyft_train, argo2_train, kitti_train, K360_train])
joint_val = dict(
        type='CustomConcatDataset',
        datasets=[nusc_test, waymo_test, lyft_val, argo2_val, kitti_val, K360_val])
