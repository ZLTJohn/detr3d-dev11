...
waymo_scale = (704,470)
waymo_pad_wh=(704,320)
waymo_crop_hw=(320,704)
# crop: h w
# LSS : h w
# pad: w h
work_dir = 'work_dirs_bevdet/W_r50_mono_bs8_smallres_no_aug_syncBN_Heightablate'
# Model
grid_config = {
    'x': [-51.2, 51.2, 0.8],
    'y': [-51.2, 51.2, 0.8],
...
waymo_img_no_aug = [dict(type='MultiViewWrapper',
    transforms=[
        ...
        dict(type='RangeLimitedRandomCrop',
            relative_x_offset_range=(1.,1.),
            relative_y_offset_range=(0.8,0.8),
            crop_size=waymo_crop_hw),
        dict(type='Pad', size=waymo_pad_wh),
...
default_hooks = dict(checkpoint=dict(
    type='CheckpointHook', interval=1, max_keep_ckpts=1, save_last=True, save_best='waymo/OBJECT_TYPE_ALL_NS_LEVEL_2/LET-mAP'))
