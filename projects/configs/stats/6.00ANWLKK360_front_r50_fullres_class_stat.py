...
class_filter = dict(type='ObjectNameFilter', classes=['Car'])
nusc_class_names = [
...
img_size_argo2 = (20,16)
img_size_nusc = (16, 9)
img_size_waymo = (19, 12)
img_scale_factor_lyft = 0.01
img_size_kitti = (12, 37)
img_size_K360 = (14, 37)
...
argo2_val_pkl = 'argo2_infos_val_2Hz_mono_front.pkl'
...
nusc_val_pkl = 'nuscenes_infos_val_mono_front.pkl'
nusc_val_interval = 1
...
waymo_val_pkl = 'waymo_infos_val_2Hz_mono_front.pkl'
...
joint_val = dict(
        ...
        datasets=[argo2_val, nusc_val, waymo_val, 
                  ...
                  argo2_train, nusc_train, waymo_train, 
                  lyft_train, kitti_train, K360_train])
...
work_dir = './work_dirs_stats/trainval_cars_stat'
