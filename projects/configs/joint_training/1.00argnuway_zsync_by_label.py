...
base_dist = 51.2
base_fxfy = 2068.5
argo2_ego_trans = [dict(type='EgoTranslate', trans = [0,0,0.513719993459064])]   # 0.513719993459064
nusc_ego_trans = [dict(type='EgoTranslate', trans = [0,0,-0.8865816593170166])] # -0.8865816593170166
waymo_ego_trans = [dict(type='EgoTranslate', trans = [0,0,1.2201894521713257])] # 1.2201894521713257
work_dir = './work_dirs_joint/1.00argnuway_zsync_by_label'
...
argo2_train_pipeline = argo2_pipeline_default + argo2_ego_trans + [
    dict(type='ObjectRangeFilter', point_cloud_range=point_cloud_range),
    dict(type='MultiViewWrapper', transforms=[dict(type='PhotoMetricDistortion3D')] + argo2_test_transforms),
    dict(type='Pack3DDetInputs', keys=['img', 'gt_bboxes_3d', 'gt_labels_3d'])
]
argo2_test_pipeline = [dict(type='evalann2ann')] + argo2_pipeline_default + argo2_ego_trans + [
    dict(type='ObjectRangeFilter', point_cloud_range=point_cloud_range),
...
nusc_train_pipeline = nusc_pipeline_default + nusc_ego_trans+ [
    dict(type='ObjectRangeFilter', point_cloud_range=point_cloud_range),
    dict(type='MultiViewWrapper', transforms=[dict(type='PhotoMetricDistortion3D')] + nusc_test_transforms),
    dict(type='Pack3DDetInputs', keys=['img', 'gt_bboxes_3d', 'gt_labels_3d'])
]
nusc_test_pipeline = [dict(type='evalann2ann')] + nusc_pipeline_default + nusc_ego_trans + [
    dict(type='ObjectRangeFilter', point_cloud_range=point_cloud_range),
...
waymo_train_pipeline = waymo_pipeline_default + waymo_ego_trans + [
    dict(type='ObjectRangeFilter', point_cloud_range=point_cloud_range),
    dict(type='MultiViewWrapper', transforms=[dict(type='PhotoMetricDistortion3D')] + waymo_test_transforms),
    dict(type='Pack3DDetInputs', keys=['img', 'gt_bboxes_3d', 'gt_labels_3d'])
]
waymo_test_pipeline = [dict(type='evalann2ann')] + waymo_pipeline_default + waymo_ego_trans + [
    dict(type='ObjectRangeFilter', point_cloud_range=point_cloud_range),
