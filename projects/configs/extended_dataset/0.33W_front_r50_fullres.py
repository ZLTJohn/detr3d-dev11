...
argo2_train_pkl = 'argo2_infos_train_2Hz_part_mono_front.pkl'  
...
waymo_train_pkl = 'waymo_infos_train_2Hz_part_mono_front.pkl'
...
input_modality = dict(use_lidar=True, # True if debug_vis
                      use_camera=True)
work_dir = './work_dirs_extended/0.33W_front_r50_fullres'
# resume = True
argo2_name_map = {
    'REGULAR_VEHICLE': 'Car',
    'LARGE_VEHICLE': 'Car',
