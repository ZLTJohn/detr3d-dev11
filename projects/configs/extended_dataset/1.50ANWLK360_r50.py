...
input_modality = dict(use_lidar=False, # True if debug_vis
                      use_camera=True)
work_dir = './work_dirs_extended/1.50ANWLK360_r50'
...
joint_train = dict(
        ...
        datasets=[argo2_train, nusc_train, waymo_train, lyft_train, K360_train])
joint_val = dict(
        type='CustomConcatDataset',
        datasets=[argo2_val, nusc_val, waymo_val, lyft_val, K360_val])
