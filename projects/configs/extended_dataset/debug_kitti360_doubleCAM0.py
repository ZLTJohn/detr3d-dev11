...
K360_train_pkl = 'kitti360_infos_train_CAM0CAM0.pkl'
K360_train_interval = 1    # 2Hz_part means interval = 5x3
K360_val_pkl = 'kitti360_infos_val_CAM0CAM0.pkl'
K360_val_interval = 1

# load_interval_factor = load_interval_type['part']
input_modality = dict(use_lidar=True, # True if debug_vis
                      use_camera=True)
work_dir = './work_dirs_extended/debug_kitti360_doubleCAM0'
K360_name_map = {
    'person': 'Pedestrian',
    'bicycle': 'Cyclist',
    'rider': 'Cyclist',
