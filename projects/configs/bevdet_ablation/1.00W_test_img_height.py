...
zero_fill_h_pre = 108
zero_fill_h_suf = 544
work_dir = 'work_dirs_mono_crop_ablate/W_bevdet_origin_bigpad_544_shift_408_1280_by_216px'
# Model
# lss: h w
# resize: w h
# crop: h w
...
waymo_test_pipeline = [
    ...
    *waymo_input_default,
    dict(type='LoadMultiViewImageFromFiles', to_float32=True),
    *waymo_img_no_aug,
    dict(type='fillzeros', hpre = zero_fill_h_pre, hsuf = zero_fill_h_suf),
    *bevdet_input_default
    ]
