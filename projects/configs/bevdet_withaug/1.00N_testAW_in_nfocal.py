...
pad_h = 448
pad_w = 960
work_dir = 'work_dirs_bevdet_mono_withaug/1.00N_testAW_fx630'
resume = True
# Model
# lss: h w
# resize: w h
...
waymo_img_no_aug = [dict(type='MultiViewWrapper',
    transforms=[
        dict(type='RandomResize', ratio_range=(0.61165, 0.61165), scale=(waymo_w,waymo_h)),
...
nusc_img_no_aug = [dict(type='MultiViewWrapper',
    transforms=[
        dict(type='RandomResize', ratio_range=(0.6,0.6), scale=(nusc_w,nusc_h)),
        dict(type='RangeLimitedRandomCrop',
            relative_x_offset_range=(1.0, 1.0),
            relative_y_offset_range=(1.0, 1.0),
            crop_size=(nusc_h_crop, nusc_w_crop)),
...
argo2_img_no_aug = [dict(type='MultiViewWrapper',
    transforms=[
        dict(type='RandomResize', ratio_range=(0.711236,0.711236), scale=(argo2_w,argo2_h)),
        dict(type='RangeLimitedRandomCrop',
