...
for x in [0,2]:
    for y in [0,2]:
        ckpt = '/home/zhenglt/mmdev11/detr3d-dev11/work_dirs_mono_ablate/1.00W_fx2070_CPAsampler_front/epoch_24.pth'
        src_cfg = '/home/zhenglt/mmdev11/detr3d-dev11/projects/configs/mono_W_shift_test/1.00W_fx2070_CPAsampler_front_shifteval.py'
        work_dir = './work_dirs_mono_egoXZ_ablate/W_fx2070_CPAsampler_shift_x{}_y{}'.format(x,y)
