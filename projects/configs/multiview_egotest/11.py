...
evaluation_interval = 12 # epochs1.5
# load_from = 'ckpts/'
...
default_feature_sampler= dict(type='DefaultFeatSampler')
geo_aware_feture_sampler = dict(type='GeoAwareFeatSampler', base_fxfy = 2068.5, base_dist = 51.2)
# Default or ManyCam or single Cam
default_crossattn = dict(type='Detr3DCrossAtten',num_cams = argo2_num_views, waymo_with_nuscene = True, waymo_with_argo2 = True,)
ManyCam_crossattn = dict(type='Detr3DCrossAtten_ManyCam', num_cams = 18)
OneCam_crossattn = dict(type='Detr3DCrossAtten_CamEmb', num_cams = 1)

argo2_egoXY = dict(type='EgoTranslate', trans = [1.3493238413,0.0031899048,0])
argo2_egoZ = dict(type='EgoTranslate', trans = [0,0,+1.5])
...
nusc_egoZ = dict(type='EgoTranslate', trans = [0,0,+1.5])
...
waymo_egoZ = dict(type='EgoTranslate', trans = [0,0,+1.5])

work_dir = './work_dirs_multiview_egotest/3.00ANW_Ksync1035_pos1.5'
...
lyft_egoZ = dict(type='EgoTranslate', trans = [0,0,+1.5])
...
ego_aug_train = []
# ego_aug_train = [dict(type='EgoTranslate', Tr_range = [-2.5,-1,-0.5, 2.5,1,0.5], eval=False)]

ego_aug_eval = []
# ego_aug_eval = [dict(type='EgoTranslate', Tr_range = [-2.5,-1,-0.5, 2.5,1,0.5])]
