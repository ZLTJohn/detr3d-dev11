...
argo2_egoZ = dict(type='EgoTranslate', trans = [0,0,0])
...
nusc_egoZ = dict(type='EgoTranslate', trans = [0,0,0])
...
waymo_egoZ = dict(type='EgoTranslate', trans = [0,0,0])

work_dir = './work_dirs_multiview_egotest/3.00ANW_Ksync1035_0'
...
lyft_egoZ = dict(type='EgoTranslate', trans = [0,0,0])
