...
argo2_egoZ = dict(type='EgoTranslate', trans = [0,0,+0.3])
...
nusc_egoZ = dict(type='EgoTranslate', trans = [0,0,+0.3])
...
waymo_egoZ = dict(type='EgoTranslate', trans = [0,0,+0.3])

work_dir = './work_dirs_multiview_egotest/3.00ANW_Ksync1035_pos0.3'
...
lyft_egoZ = dict(type='EgoTranslate', trans = [0,0,+0.3])
