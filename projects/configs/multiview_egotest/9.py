...
argo2_egoZ = dict(type='EgoTranslate', trans = [0,0,+0.9])
...
nusc_egoZ = dict(type='EgoTranslate', trans = [0,0,+0.9])
...
waymo_egoZ = dict(type='EgoTranslate', trans = [0,0,+0.9])

work_dir = './work_dirs_multiview_egotest/3.00ANW_Ksync1035_pos0.9'
...
lyft_egoZ = dict(type='EgoTranslate', trans = [0,0,+0.9])
