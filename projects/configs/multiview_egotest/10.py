...
argo2_egoZ = dict(type='EgoTranslate', trans = [0,0,+1.2])
...
nusc_egoZ = dict(type='EgoTranslate', trans = [0,0,+1.2])
...
waymo_egoZ = dict(type='EgoTranslate', trans = [0,0,+1.2])

work_dir = './work_dirs_multiview_egotest/3.00ANW_Ksync1035_pos1.2'
...
lyft_egoZ = dict(type='EgoTranslate', trans = [0,0,+1.2])
