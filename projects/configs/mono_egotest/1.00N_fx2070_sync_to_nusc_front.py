...
input_modality = dict(use_lidar=True, # True if debug_vis
                      use_camera=True)
argo_egoZ = dict(type='EgoTranslate', trans = 'FrontCam')
waymo_egoZ = dict(type='EgoTranslate', trans = 'FrontCam')
kitti_egoZ = dict(type='EgoTranslate', trans = 'FrontCam')
nusc_egoZ = dict(type='EgoTranslate', trans = [-0.40350406,-0.01299096,0.32624862])
K360_egoZ = dict(type='EgoTranslate', trans = 'FrontCam')
lyft_egoZ = dict(type='EgoTranslate', trans = 'FrontCam')
work_dir = './work_dirs_mono_egotest/1.00N_fx2070_sync_to_nusc_front'
# resume = True
argo2_name_map = {
    'REGULAR_VEHICLE': 'Car',
    'LARGE_VEHICLE': 'Car',
