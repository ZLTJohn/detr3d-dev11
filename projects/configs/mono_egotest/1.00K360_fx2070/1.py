...
input_modality = dict(use_lidar=True, # True if debug_vis
                      use_camera=True)
argo_egoZ = dict(type='EgoTranslate', trans = [0,0,-2.1])
waymo_egoZ = dict(type='EgoTranslate', trans = [0,0,-2.1])
kitti_egoZ = dict(type='EgoTranslate', trans = [0,0,-2.1])
nusc_egoZ = dict(type='EgoTranslate', trans = [0,0,-2.1])
K360_egoZ = dict(type='EgoTranslate', trans = [0,0,-2.1])
lyft_egoZ = dict(type='EgoTranslate', trans = [0,0,-2.1])
work_dir = './work_dirs_mono_egotest/1.00K360_fx2070_egoZSync_neg2.1'
# resume = True
argo2_name_map = {
    'REGULAR_VEHICLE': 'Car',
    'LARGE_VEHICLE': 'Car',
