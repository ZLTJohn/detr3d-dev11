...
input_modality = dict(use_lidar=True, # True if debug_vis
                      use_camera=True)
work_dir = './work_dirs_mono_egotest/1.00N_fx1260_CPA_sampler_front_egoshift_2xy' 
nusc_egoshift_test = dict(type='EgoTranslate',eval=True,Tr_range=[-2,-2,0,2,2,0], frame_wise = True)
# resume = True
argo2_name_map = {
    'REGULAR_VEHICLE': 'Car',
    'LARGE_VEHICLE': 'Car',
