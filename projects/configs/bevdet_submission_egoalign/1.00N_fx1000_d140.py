...
nusc_train_pkl = 'nuscenes_infos_train_mono_front_egoalign.pkl'
nusc_val_pkl = 'nuscenes_infos_val_part_mono_front_egoalign.pkl'
nusc_h = 450
nusc_w = 800
nusc_h_crop = 307
nusc_w_crop = 800
...
argo2_train_pkl = 'argo2_infos_train_2Hz_mono_front_egoalign.pkl'  
argo2_train_interval = 1    # 2Hz_part means interval = 5x3
argo2_val_pkl = 'argo2_infos_val_2Hz_part_mono_front_egoalign.pkl'
...
lyft_train_pkl = 'lyft_infos_train_mono_front_egoalign.pkl' 
lyft_train_interval = 1
lyft_val_pkl = 'lyft_infos_val_mono_front_egoalign.pkl'
lyft_val_interval = 2
lyft_small_h = 1024//2
lyft_small_w = 1224//2
...
kitti_train_pkl = 'kitti_infos_train_egoalign.pkl'
kitti_train_interval = 1
kitti_val_pkl = 'kitti_infos_val_egoalign.pkl'
...
K360_train_pkl = 'kitti360_infos_train_egoalign.pkl' # 40000 frame
K360_train_interval = 1
K360_val_pkl = 'kitti360_infos_val_egoalign.pkl' # 10000 frame
K360_val_interval = 5
K360_num_views = 1
...
pad_w = 960
focal_length=1000
work_dir = 'work_dirs_bevdet_submission_egoalign/1.00N_fx1000_d140'
resume = True
# Model
# lss: h w
# resize: w h
...
img_norm_cfg = dict(
    ...
    bgr_to_rgb=True)
debug_vis_cfg = dict(debug_dir='debug/dataset_egoalign',
                     gt_range=[0, 105],
...
nusc_bev_aug = [dict(type='GlobalRotScaleTrans',
           ...
           dict(type='RandomFlip3D',
                ...
                flip_ratio_bev_horizontal=0.5,
                flip_ratio_bev_vertical=0.5)]
nusc_bev_noaug = [dict(type='GlobalRotScaleTrans',rot_range=[0,0],
...
lyft_bev_aug = [dict(type='GlobalRotScaleTrans',
           ...
           dict(type='RandomFlip3D',
                ...
                flip_ratio_bev_horizontal=0.5,
                flip_ratio_bev_vertical=0.5)]
lyft_bev_noaug = [dict(type='GlobalRotScaleTrans',rot_range=[0,0],
                       scale_ratio_range=[1.0,1.0],
                       translation_std=[0, 0, 0]),]
lyft_input_default = [
    dict(type='LoadPointsFromFile',coord_type='LIDAR', load_dim=5, use_dim=5),
...
default_hooks = dict(checkpoint=dict(
    type='CheckpointHook', interval=4, max_keep_ckpts=4, save_last=True, save_best='all_dataset/OBJECT_TYPE_ALL_NS_LEVEL_2/LET-mAP'))
