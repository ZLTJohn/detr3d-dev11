...
pad_w = 960
focal_length=1000
work_dir = 'work_dirs_bevdet_submission_egoalign/6.00NALKK360W_fx1000_d140'
resume = True
# Model
# lss: h w
# resize: w h
...
joint_train = dict(
        ...
        datasets=[argo2_train,nusc_train,lyft_big_train,
                  lyft_small_train,kitti_train,K360_train,
                  waymo_train])
joint_val = dict(
        type='CustomConcatDataset',
